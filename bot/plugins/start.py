...
async def start(c, m):
    ...
    await m.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('📌  Support Group', url='https://t.me/The_MoviesRequest1'),
                    InlineKeyboardButton('🔖  Projects Channel', url='https://t.me/RJ_BOTS_2024')
                ],
                [
                    InlineKeyboardButton('💡  Source Code', url='https://github.com'),
                    InlineKeyboardButton('👨  Master', url='https://t.me/ROHANKUMARJENA')
                ]
            ]
        )
    )
